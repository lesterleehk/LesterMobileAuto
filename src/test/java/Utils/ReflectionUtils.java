...
public class ReflectionUtils {
	...
	public static Field getField_superClz(Class<? extends TestCaseBasicInfo> clz, String fieldName){
			
		//System.out.println("Clz.getName()="+clz.getName()+"; fieldName="+fieldName);
		Field field = null;
		Class<? extends TestCaseBasicInfo> orginalClz=clz;
		try {
			Class superClz = null ;
	...
	public static String getFieldValueAsString(TestCaseBasicInfo testObject, String fieldName){
		String fieldValue = "";
	...
	public static ArrayList<TestCaseBasicInfo> getFieldValueAsTestObjectArray(TestCaseBasicInfo testObject, String fieldName){
		ArrayList<TestCaseBasicInfo> fieldValue = null;
		
		try {
			Class clz = testObject.getClass();
			Field field = ReflectionUtils.getField(clz, fieldName);
			field.setAccessible(true);
			fieldValue = (ArrayList<TestCaseBasicInfo>) field.get(testObject);
		} catch (SecurityException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IllegalArgumentException e) {
